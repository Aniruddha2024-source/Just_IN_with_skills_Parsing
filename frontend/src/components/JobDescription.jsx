...
//             try {
//                 setLoading(true);
//                 const res = await axios.get(`${JOB_API_END_POINT}/get/apply`,  {
//   jobId: job._id, // or whichever variable has job ID
...
//         return <div className="text-center py-10 text-lg">Loading job details...</div>;
//     }
...
const JobDescription = () => {
  ...
  const applyJobHandler = async () => {
    try {
      const res = await axios.post(`${APPLICATION_API_END_POINT}/apply`, {
        jobId: jobId
      }, {
        withCredentials: true
      });
