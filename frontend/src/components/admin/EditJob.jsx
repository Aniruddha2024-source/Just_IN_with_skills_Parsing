...
const EditJob = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!jobData.companyId || jobData.companyId.length !== 24) {
    ...
    return (
        <div className="max-w-xl mx-auto mt-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <input name="companyId" value={jobData.companyId} onChange={handleChange} placeholder="Company ID" className="w-full border p-2" />
